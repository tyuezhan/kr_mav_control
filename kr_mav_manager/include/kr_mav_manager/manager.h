...
class MAVManager
{
 ...
 private:
  ...
  typedef actionlib::SimpleActionClient<kr_tracker_msgs::BsplineTrackerAction> BsplineClientType;
  ...
  BsplineClientType bspline_tracker_client_;
